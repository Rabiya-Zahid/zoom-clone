...
console.log("VIDEO ENABLED:", stream.getVideoTracks()[0]?.enabled);
console.log("VIDEO READY STATE:", stream.getVideoTracks()[0]?.readyState);
    ...
    let getUserMedia = () => {
        if ((video && videoAvailable) || (audio && audioAvailable)) {
            navigator.mediaDevices.getUserMedia({ video: video, audio: audio })
                ...
                .then((stream) => { console.log("AUDIO TRACKS:", stream.getAudioTracks());
